...
export type DeckWithTxHash = {
    txHash: string,
    index: number,
    deck: CardPosition[]
}

export type DecksWithTxHash = DeckWithTxHash[]

export type CardedDeckWithTxHash = {
    txHash: string,
    index: number,
    deck: Card[]
}

export type CardedDecksWithTxHash = CardedDeckWithTxHash[]
